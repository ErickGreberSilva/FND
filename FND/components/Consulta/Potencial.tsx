...
export default function Potencial() {
    ...
    const initMap = async () => {
      ...
      if (mapRef.current && !mapRef.current.hasChildNodes()) {
        ...
        L.tileLayer(
          ...
          {
            attribution:
              'Tiles © <a href="https://services.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer">Esri</a>',
          }
        ).addTo(map);
  ...
  //   const highlightLayer = (window as any).L.esri
  //     .featureLayer({
  ...
  return (
    <div
      ref={mapRef}
      className="w-full h-[500px] drop-shadow-lg rounded border border-b-blue-50"
    />
  );
}
